...
// scroll-color.js - Changes the color of the scroll-top element
document.addEventListener("DOMContentLoaded", function() {
    const scrollTopButton = document.getElementById('scroll-top');
    
    if (scrollTopButton) {
        // Change the scroll-top SVG color
        const svgPath = scrollTopButton.querySelector('svg path');
        if (svgPath) {
            svgPath.setAttribute('fill', '#ff6b6b'); // Change color 
        }
